...
export default function DashboardMarketplacePage() {
  ...
  const { data, loading, error } = useApiGet(
    schoolId ? `/schools/${schoolId}/marketplace/providers` : null,
    {
      params: {
  ...
  return (
    <Box sx={{ maxWidth: 800, mx: "auto" }}>
      ...
      <Typography color="text.secondary" sx={{ mb: 3 }}>
        Enseignants, formateurs, chauffeurs, fournisseurs, imprimeurs,
        librairies vérifiés par la plateforme.
      </Typography>
          ...
          {providers.map((p) => {
            ...
            return (
              <Card
                key={p.id}
                variant="outlined"
                sx={isBoosted ? { borderColor: "primary.main" } : undefined}
              >
                <CardContent>
                  <Stack
                    direction="row"
                  ...
                  >
                    ...
                    {isBoosted && (
                      <Chip label="Sponsorisé" color="primary" size="small" />
                    )}
                    <Chip
                      label={
