...
export default function DashboardMessagesPage() {
  ...
  } = useApiGet(schoolId ? `/schools/${schoolId}/messages/inbox` : null);
  ...
  async function loadThread(userId, { silent = false } = {}) {
    ...
    try {
      const response = await api.get(
        `/schools/${schoolId}/messages/threads/${userId}`,
      );
  ...
  async function handleSend() {
    ...
    try {
      await api.post(
        `/schools/${schoolId}/messages/threads/${selectedUserId}`,
        { body: trimmed },
      );
      setBody("");
            ...
            {!selectedUserId && (
              ...
              >
                ...
                <Typography variant="body2">
                  Sélectionnez un fil pour l'afficher.
                </Typography>
              </Box>
            )}
            {selectedUserId && (
