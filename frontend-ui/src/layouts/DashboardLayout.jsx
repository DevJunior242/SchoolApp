    ...
    items: [
      {
        ...
        to: "/dashboard/enrollment-requests",
        icon: <HowToRegIcon />,
      },
    ],
  },
...
const PARENT_NAV_GROUPS = singleGroup([
  ...
  {
    label: "Assistant IA",
    to: "/dashboard/my-children-ai-assistant",
    icon: <SmartToyIcon />,
    badge: "IA",
  },
  {
  ...
  {
    label: "Bus scolaire",
    to: "/dashboard/my-children-bus",
    icon: <DirectionsBusIcon />,
  },
  {
    label: "Bibliothèque",
    to: "/dashboard/my-children-library",
    icon: <LocalLibraryIcon />,
  },
  {
    label: "Cours",
...
const PRESTATAIRE_NAV_GROUPS = singleGroup([
  ...
  {
    label: "Mes articles",
    to: "/dashboard/my-marketplace-items",
    icon: <StorefrontIcon />,
  },
]);
...
const SUPERADMIN_NAV_GROUPS = singleGroup([
  ...
  {
    label: "Tarifs SaaS",
    to: "/dashboard/school-pricing-plans",
...
export default function DashboardLayout() {
  ...
  function renderDrawerContent(isCollapsed) {
    ...
    const showSchoolSwitcher =
      !isSuperAdmin && !isPrestataire && schoolUsers.length > 0;
    const roleLabel = schoolUsers.find(
      (su) => su.school.id === user.current_school_id,
    )?.role?.name;
                  ...
                  const button = (
                    ...
                    >
                      ...
                      {!isCollapsed && item.disabled && (
                        <Chip label="Bientôt" size="small" variant="outlined" />
                      )}
                    </ListItemButton>
                  );
